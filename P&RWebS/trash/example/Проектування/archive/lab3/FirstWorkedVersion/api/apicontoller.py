...
class apiController:
    ...
    tonce = 0
    signature = 0  
    secret_key = 'xRWIwqx3XNqnO1NvzLTeC0LLN3AsZlV9CPjp8x1x'
    ...
    def updateSignature(self):
        #s = 'GET|/api/v2/trades/my|access_key=dV6vEJe1CO&market=btcuah&tonce=1465850766246'
        #s = s.encode()
        #return hmac.new(b'AYifzxC3Xo', msg=s, digestmod=hashlib.sha256).hexdigest()
        self.updateTonce()
